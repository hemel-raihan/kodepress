...
function handleMobileChange(e) {
    ...
    if (e.matches) {
        ...
        document.getElementById("online_comment_view").style.cssText = "position:fixed;left:5%;top:5%;background-color:#fff;z-index:10000;width:90%;min-height:300px;box-shadow:0 0 15px #000;border-radius:5px;";
        document.getElementById("close_online_comment_view").style.cssText =
            "position:absolute;width:30px;height:30px;line-height:30px;text-align:center;right:auto;left:-15px;top:15px;background-color:#fff;border-radius:50%;cursor:pointer;box-shadow:0 0 5px #000;z-index:5";
    } else {
        document.getElementById("online_comment_view").style.cssText = "position:fixed;left:15%;top:5%;background-color:#fff;z-index:10000;width:70%;min-height:300px;box-shadow:0 0 15px #000;border-radius:5px;";
        document.getElementById("close_online_comment_view").style.cssText =
            "position:absolute;width:30px;height:30px;line-height:30px;text-align:center;left:auto;right:-15px;top:15px;background-color:#fff;border-radius:50%;cursor:pointer;box-shadow:0 0 5px #000;z-index:5";
    }
}
...
async function loadCommentSection(e, comment_type_id = "") {
    ...
    elm.innerHTML =
        '<span id="close_online_comment_view" onclick="closeCommentSection(this)">x</span><object data="' +
        url +
        "?req_from=" +
        __cur_location.host +
        "&path=" +
        __cur_location.pathname +
        (comment_type_id ? "&type_id=" + comment_type_id : "") +
    ...
    document.getElementById("close_online_comment_view").style.cssText =
        "position:absolute;width:30px;height:30px;line-height:30px;text-align:center;right:-10px;top:-10px;background-color:#fff;border-radius:50%;cursor:pointer;box-shadow:0 0 5px #000;z-index:5";
