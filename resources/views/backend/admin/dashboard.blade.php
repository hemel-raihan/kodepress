											...
											<table id="data-table" class="table table-bordered text-nowrap mb-0">
												...
												<tbody>
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/11.jpg')}})"></span>
													...
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/1.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
													...
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/12.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
													...
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/13.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
													...
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/2.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
													...
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/14.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
													...
													<tr class="border-bottom">
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/4.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
																	<h6 class="mb-0 fs-14 fw-semibold">Trevor Thomson</h6>
																	<span class="fs-12 text-muted">trevor@gmail.com</span>
																</div>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																<span class="avatar avatar-md brround mt-1" style="background-image: url({{ asset('assets/images/users/5.jpg')}})"></span>
																<div class="ms-2 mt-0 mt-sm-2 d-block">
