...
@section('content')
						...
						<div class="page-header">
							<div>
								<h1 class="page-title">{{ isset($widget) ? 'Edit ' : 'Create '}}Widget ({{$page->title}})</h1>
								{{-- <ol class="breadcrumb">
							...
							<div class="ms-auto pageheader-btn">
								<a href="{{route('admin.pagebuilder.builder',$page->id)}}" class="btn btn-primary btn-icon text-white me-2">
									<span>
		...
		<div class="col-lg-9 col-xl-9 col-md-12 col-sm-12">
			<div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control " value="{{$widget->no_of_post ?? old('no_of_post')}}" name="padding" id="" placeholder="How many post you want to show">
                </div>

                <div class="form-group">
                    <label for="exampleInputname">margin</label>
                    <input type="number" class="form-control " value="{{$widget->no_of_post ?? old('no_of_post')}}" name="margin" id="" placeholder="How many post you want to show">
                </div>
