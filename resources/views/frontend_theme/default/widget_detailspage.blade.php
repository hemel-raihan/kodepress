...
<div class="sixteen columns" id="left-content">
    ...
    <div class="updateText" style="float: right; font-style: italic; font-size: 0.8em; color: #666;">সর্ব-শেষ হাল-নাগাদ: {{ $widget->created_at->format('Y-m-d') }}</div>
    <hr id="print_div_hr" />
